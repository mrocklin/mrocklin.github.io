...
In the era of Zoom meetings, one way to do this is with an excellent AV setup.
This document goes through my setup at home.  I got this information from a
professional interviewer, and tweaked things to my liking.
...
I use a mirrorless camera with zoom and real-time auto-focus.  These tend to
cost about $1000.

-   [Sony Alpha a6400](https://www.amazon.com/gp/product/B07MV3P7M8/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&th=1)

You need a bunch of peripherals to make this work:

-   [A charger](https://www.amazon.com/gp/product/B0744JGWQR/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1)
    so that you don't have to deal with batteries
-   [Elgato Cam Link 4K](https://www.amazon.com/gp/product/B07K3FN5MR/ref=ppx_yo_dt_b_asin_title_o07_s02?ie=UTF8&th=1) an external capture card, which effectively mounts the HDMI connection as a webcam to your computer
-   [The appropriate HDMI cable](https://www.amazon.com/gp/product/B08C2PVP7J/ref=ppx_yo_dt_b_asin_title_o03_s00?ie=UTF8&th=1)
-   [A simple tripod](https://www.amazon.com/gp/product/B005KP473Q/ref=ppx_yo_dt_b_asin_title_o07_s00?ie=UTF8&psc=1) to mount the camera
-   And optionally, [a remote](https://www.amazon.com/gp/product/B08LP5QYW8/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&th=1)
...
-  [Good lights](https://www.amazon.com/gp/product/B07ZCYMS3V/ref=ppx_yo_dt_b_asin_title_o07_s01?ie=UTF8&psc=1)
...
-   [Shure MV7](https://www.amazon.com/gp/product/B08G7RG9ML/ref=ppx_yo_dt_b_asin_title_o06_s00?ie=UTF8&th=1) a solid recording microphone, similar to what professional podcasters use
-   [Suspension Boom arm stand](https://www.amazon.com/gp/product/B07X1ZWS2H/ref=ppx_yo_dt_b_asin_title_o03_s00?ie=UTF8&th=1) to position the mic right up against my mouth
...
-  [Green Screen](https://www.amazon.com/gp/product/B07DWTGLPM/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1)
...
When doing screen recordings I use [Open Broadcaster Software (OBS)](https://obsproject.com/).  It takes about half-a-day to configure everything.  In particular I needed to set the following up:
