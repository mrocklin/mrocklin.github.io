...
We often need to balance prioritization between internal-facing work and
user-facing work.  It's helpful to distinguish between these.
...
Developer valued work is also valuable, but only in that it makes us faster in
delivering user-valued work to users.

## Timing and Judgement

We are judged as a team on user-valued work in the long term.
Developer-valued work is good, but only in service of user-valued work.
...
team, user-valued changes are typically what matter.  This typically matches
how the public judges the work as well.
